...
// a fixed 248 px sidebar from `md` up, a top bar with a hamburger below it,
// and the same sidebar content inside an accessible drawer (Radix Dialog:
// focus trap, Escape, overlay click). The drawer closes on navigation.
      ...
      <header className="border-line bg-card sticky top-0 z-30 flex h-14 items-center gap-3 border-b px-3 md:hidden">
        <Dialog.Root open={open} onOpenChange={setOpen}>
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content
              className="bg-card data-[state=open]:animate-in data-[state=open]:slide-in-from-left data-[state=closed]:animate-out data-[state=closed]:slide-out-to-left fixed inset-y-0 left-0 z-50 flex w-[288px] max-w-[88vw] flex-col px-4 pt-5 pb-4 shadow-xl outline-none"
            >
