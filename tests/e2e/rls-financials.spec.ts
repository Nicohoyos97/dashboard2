...
const OPEN = ['insights', 'bank_accounts', 'financial_periods'] as const;
...
const OPEN_ALL = { insights: 1, bank_accounts: 1, financial_periods: 1 };
const OPEN_NONE = { insights: 0, bank_accounts: 0, financial_periods: 0 };
...
test.describe('RLS financials, taxes, reminders and AI tables', () => {
  ...
  async function seed(b: Tenant, a: Tenant) {
    ...
    return { reportId, lineIds, accountId, statementId, obligationId, reminderId, sessionId };
  }
